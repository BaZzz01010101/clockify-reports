...
const api: ClockifyDesktopApi = {
  ...
  validateAndStoreApiKey: (apiKey) => ipcRenderer.invoke(IPC_CHANNELS.authValidateAndStoreApiKey, apiKey),
  ...
  exportDetailedReport: (request) => ipcRenderer.invoke(IPC_CHANNELS.clockifyExportDetailedReport, request),
